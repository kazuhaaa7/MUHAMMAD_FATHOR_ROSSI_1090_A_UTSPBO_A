...
//        {
//            List<LayananMotor> lm1 = new List<LayananMotor>("rossi", "0001", "bwi", 20000);
//            lm1.HitungTarif(10);
...
//        public PesananTansportasi(string nm, string id, string lokasitujuan, List<LayananMotor> sdsfi)
//        {
